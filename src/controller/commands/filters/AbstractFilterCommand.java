...
/**
 * Abstract base class for implementations of ImageCommand that apply an image filter kernel to an
 * image {@link ImageCommand}.
 */
public abstract class AbstractFilterCommand extends AbstractCommand {
   ...
   */
  public AbstractFilterCommand(String imageName, String destImageName, double[][] kernel) {
