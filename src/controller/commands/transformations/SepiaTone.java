...
public class SepiaTone extends AbstractColorTransform {
  /**
   * Constructor for Sepia tone. Initialized transformation matrix with a 3x3 matrix which produces
   * a sepia tone effect. {{0.393, 0.769, 0.189}, {0.349, 0.686, 0.168}, {0.272, 0.534, 0.131}}.
   *
